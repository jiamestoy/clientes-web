...
<template>
    <section class="container">
        ...
        <router-link class="block p-2 my-2 bg-white border-2 border-green-700 text-green-700 rounded text-center" to="lista-usuarios">Lista de Usuarios</router-link>

        <router-link class="block p-2 my-2 bg-green-700 text-white rounded text-center" to="lista-mensajes">Mensajes</router-link>
